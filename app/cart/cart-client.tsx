...
export default function CartPageClient() {
    ...
    const onSubmit = async (data: OrderFormData) => {
        ...
        try {
            ...
            toast.error(
                <div>
                    <div className="font-semibold">⚠️ Ошибка при оформлении заказа</div>
                    <div className="text-sm mt-1">{error?.message || 'Проверьте подключение к интернету и попробуйте снова'}</div>
                </div>,
                { duration: 5000 }
            );
        } finally {
    ...
    return (
        <div className="container mx-auto px-2 py-4 sm:px-4 sm:py-8">
            ...
            <div className="mx-auto max-w-6xl px-0 sm:px-6 lg:px-8">
                <h1 className="mb-4 sm:mb-8 text-xl font-bold sm:text-2xl lg:text-3xl px-2 sm:px-0">Корзина - Заявка на покупку</h1>

                {/* Информационный блок о заявке */}
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                <h3 className="text-sm sm:text-base font-semibold text-blue-900 mb-1">
                                    Это заявка на покупку - сейчас оплата не требуется!
                                </h3>
                                <p className="text-xs sm:text-sm text-blue-800">
                                    Вы формируете заявку на пиротехнику. После оформления мы свяжемся с вами для подтверждения деталей и обсуждения оплаты.
                                </p>
                            </div>
                        </div>
                    </div>
                                        ...
                                        {watch('contactMethod') && (
                                            <div>
                                                ...
                                                <Input
                                                    ...
                                                    {...register('contact')}
                                                    type={
                                                        watch('contactMethod') === 'phone' || watch('contactMethod') === 'whatsapp'
                                                            ? 'tel'
                                                            : 'text'
                                                    }
                                                    placeholder={

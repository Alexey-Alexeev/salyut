...
export const metadata: Metadata = {
  ...
  description:
    'Оформление заказа фейерверков и салютов. Быстрая доставка по Москве и МО. Организация запуска салютов. Безопасная оплата, гарантия качества.',
  keywords:
    'корзина фейерверков, заказ салютов, купить фейерверки, доставка пиротехники москва, безопасный запуск салютов',
  openGraph: {
    title: 'Корзина - Фейерверки и салюты',
    description:
      'Оформление заказа фейерверков и салютов. Быстрая доставка по Москве и МО. Организация запуска салютов.',

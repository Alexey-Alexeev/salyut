                    ...
                    <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="space-y-4 text-gray-700 leading-relaxed">
                                <p>
                                    Настоящее Пользовательское соглашение (далее – «Соглашение») регулирует отношения между администрацией сайта <strong className="text-orange-600">салютград.рф</strong> (далее – «Администрация») и пользователями данного сайта (далее – «Пользователь»).
                                </p>
                                <div className="bg-amber-50 border-l-4 border-amber-400 p-4 rounded-r-lg">
                                    <p className="text-amber-800 font-medium">
                                        Используя сайт салютград.рф, вы автоматически соглашаетесь с условиями настоящего Соглашения. Если вы не согласны с какими-либо условиями, пожалуйста, прекратите использование сайта.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="space-y-6">
                                <div className="bg-gray-50 rounded-lg p-6">
                                    ...
                                    <p className="text-gray-700 leading-relaxed">
                                        Настоящее Соглашение определяет условия использования сайта салютград.рф, включая все его поддомены, страницы и сервисы, а также права и обязанности Пользователей и Администрации.
                                    </p>
                                </div>
                    ...
                    <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-gray-50 rounded-lg p-6">
                                    <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                                        <span className="w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-sm font-bold mr-3">3.3</span>
                                        Возврат и обмен
                                    </h3>
                                    <p className="text-gray-700 leading-relaxed">
                    ...
                    <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-gray-50 rounded-lg p-6">
                                    <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                                        <span className="w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-sm font-bold mr-3">4.3</span>

...
export const metadata: Metadata = {
  title: 'Безопасный запуск салютов | Организация запуска пиротехники',
  description:
    'Безопасный запуск салютов и фейерверков в Москве и МО. Организация запуска пиротехники для свадеб, дней рождения, корпоративов и ваших праздников. Индивидуальный подход.',
  keywords:
    'безопасный запуск салютов, запуск фейерверков на свадьбу, пиротехника на день рождения, организация запуска салютов, безопасная пиротехника, салюты москва',
  openGraph: {
    title: 'Безопасный запуск салютов',
    description:
      'Безопасный запуск салютов и фейерверков в Москве и МО. Организация запуска пиротехники для свадеб, дней рождения, корпоративов и ваших праздников.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Безопасный запуск салютов - СалютГрад',
      },
      {

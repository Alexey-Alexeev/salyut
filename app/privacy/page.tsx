                            ...
                            <div className="space-y-4 sm:space-y-6">
                                <div className="bg-gray-50 rounded-lg p-4 sm:p-6">
                                    ...
                                    <p className="text-sm sm:text-base text-gray-700 leading-relaxed break-words">
                                        Настоящая Политика является неотъемлемой частью Публичной оферты (далее – «Оферта»), размещенной и/или доступной в сети Интернет по адресу: <strong className="text-orange-600">https://salutgrad.ru</strong>, а также иных заключаемых с Пользователем договоров, когда это прямо предусмотрено их условиями.
                                    </p>
                                </div>
                            ...
                            <div className="space-y-6">
                                <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg p-4 sm:p-6 border border-purple-200 overflow-hidden">
                                    <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center break-words">
                                        ...
                                        <span className="break-words">Под персональной информацией понимается:</span>
                                    </h3>
                            ...
                            <div className="space-y-6">
                                <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-lg p-4 sm:p-6 border border-orange-200 overflow-hidden">
                                    <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center break-words">
                                        ...
                                        <span className="break-words">Принципы сбора данных</span>
                                    </h3>
                                    <p className="text-gray-700 leading-relaxed break-words">
                                ...
                                <div className="bg-gray-50 rounded-lg p-4 sm:p-6 overflow-hidden">
                                    <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center break-words">
                                        ...
                                        <span className="break-words">Цели обработки персональной информации</span>
                                    </h3>
                            ...
                            <div className="space-y-6">
                                <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-lg p-4 sm:p-6 border border-indigo-200 overflow-hidden">
                                    <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center break-words">
                                        ...
                                        <span className="break-words">Права пользователя</span>
                                    </h3>
                                    <p className="text-gray-700 leading-relaxed break-words">
                                ...
                                <div className="bg-gray-50 rounded-lg p-4 sm:p-6 overflow-hidden">
                                    <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center break-words">
                                        ...
                                        <span className="break-words">Ограничения</span>
                                    </h3>
                                    <p className="text-gray-700 leading-relaxed break-words">
                            ...
                            <div className="space-y-6">
                                <div className="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-lg p-4 sm:p-6 border border-teal-200 overflow-hidden">
                                    <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center break-words">
                                        ...
                                        <span className="break-words">Использование Cookie</span>
                                    </h3>
                                    <p className="text-gray-700 leading-relaxed break-words">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-gray-200">
                    <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="bg-gradient-to-r from-emerald-50 to-green-50 rounded-lg p-4 sm:p-6 border border-emerald-200 overflow-hidden">
                                <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center break-words">
                                    <span className="w-6 h-6 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center text-sm font-bold mr-3 flex-shrink-0">7.1</span>
                                    <span className="break-words">Меры защиты</span>
                                </h3>
                                <p className="text-gray-700 leading-relaxed break-words">
                    ...
                    <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="bg-white rounded-lg p-4 sm:p-6 shadow-sm overflow-hidden">
                                <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center break-words">
                                    <span className="w-6 h-6 bg-orange-100 text-orange-600 rounded-full flex items-center justify-center text-sm font-bold mr-3 flex-shrink-0">9.1</span>
                                    <span className="break-words">Способы связи</span>
                                </h3>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                                    ...
                                    <div className="bg-gray-50 rounded-lg p-3 sm:p-4 text-center">
                                        ...
                                        <p className="text-xs sm:text-sm text-gray-700 break-words">143921, Московская область, деревня Чёрное, улица Агрогородок, вл31</p>
                                    </div>
                                </div>
                            </div>
                        </div>

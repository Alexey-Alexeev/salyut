    ...
    const categoriesData = [
      {
        name: 'Петарды',
        slug: 'firecrackers',
        description: 'Петарды и хлопушки для праздников',
      },
      { name: 'Ракеты', slug: 'rockets', description: 'Ракеты и салюты' },
      {
        name: 'Фонтаны',
        slug: 'fountains',
        description: 'Фонтаны и батареи салютов',
      },
      {
        name: 'Римские свечи',
        slug: 'roman-candles',
        description: 'Римские свечи и фейерверки',
      },
      {
        name: 'Бенгальские огни',
        slug: 'sparklers',
        description: 'Бенгальские огни и свечи',
      },
    ];
    ...
    const manufacturersData = [
      {
        ...
        country: 'Россия',
        description: 'Ведущий производитель пиротехники в России',
      },
      {
        name: 'Пиротехника-М',
        country: 'Россия',
        description: 'Качественная пиротехника для праздников',
      },
      {
        name: 'Фейерверк-Люкс',
        country: 'Россия',
        description: 'Премиум фейерверки и салюты',
      },
      {
        name: 'Праздник-Пиро',
        country: 'Россия',
        description: 'Пиротехника для всех праздников',
      },
    ];
    ...
    const productsData = [
      {
        ...
        manufacturer_id: manufacturersList.find(
          m => m.name === 'Русский фейерверк'
        )?.id,
        images: [
      ...
      },
      {
        ...
        manufacturer_id: manufacturersList.find(m => m.name === 'Пиротехника-М')
          ?.id,
        images: [
          'https://images.pexels.com/photos/1157557/pexels-photo-1157557.jpeg?auto=compress&cs=tinysrgb&w=800',
        ],
        description:
          'Петарды Корсар-1 - это классические петарды с громким хлопком. В упаковке 50 штук.',
        characteristics: {
          Тип: 'Петарда',
      ...
      },
      {
        ...
        manufacturer_id: manufacturersList.find(
          m => m.name === 'Фейерверк-Люкс'
        )?.id,
        images: [
          'https://images.pexels.com/photos/1387174/pexels-photo-1387174.jpeg?auto=compress&cs=tinysrgb&w=800',
        ],
        description:
          'Фонтан Вулкан создает эффект извержения вулкана с яркими искрами и дымом.',
        characteristics: {
          Тип: 'Фонтан',
      ...
      },
      {
        ...
        category_id: categoriesList.find(c => c.slug === 'rockets')?.id,
        manufacturer_id: manufacturersList.find(m => m.name === 'Праздник-Пиро')
          ?.id,
        images: [
          'https://images.pexels.com/photos/1387172/pexels-photo-1387172.jpeg?auto=compress&cs=tinysrgb&w=800',
        ],
        description:
          'Набор из 12 ракет Комета с яркими хвостами и эффектными взрывами.',
        characteristics: {
          Тип: 'Ракета',
      ...
      },
      {
        ...
        description:
          'Бенгальские огни Звездочки - безопасные и красивые огни для детей и взрослых.',
        characteristics: {
      ...
      },
      {
        ...
        description:
          'Римская свеча с 8 выстрелами, создающими эффект огненного дождя.',
        characteristics: {
          Тип: 'Римская свеча',
      ...
      },
      {
        ...
        description:
          'Мощный салют с 50 залпами различных эффектов. Идеален для больших праздников.',
        characteristics: {
          Тип: 'Салют',
      ...
      },
      {
        ...
        description:
          'Петарды Гром - самые громкие петарды в нашем ассортименте. 100 штук в упаковке.',
        characteristics: {
          Тип: 'Петарда',

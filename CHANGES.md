...
1. **app/sitemap.ts**
   ...
   - Добавлена генерация URL для всех 21 городской страницы
...
```
lib/cities.ts                           # База данных городов (21 город)
...
# Создать коммит
git commit -m "feat: добавлены локальные SEO-страницы для 21 города

- Создана система динамической генерации страниц для городов МО
- Добавлены 21 город с правильными склонениями
...
# Коммит
git commit -m "feat: добавлены локальные SEO-страницы для 21 города МО"

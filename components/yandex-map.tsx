        ...
        const initMap = () => {
            ...
            window.ymaps.ready(() => {
                const map = new window.ymaps.Map(mapRef.current, {
                    center: [DELIVERY_CONSTANTS.PICKUP_ADDRESS.coordinates.lat, DELIVERY_CONSTANTS.PICKUP_ADDRESS.coordinates.lng],
                    zoom: zoom,
                ...
                const placemark = new window.ymaps.Placemark(
                    [DELIVERY_CONSTANTS.PICKUP_ADDRESS.coordinates.lat, DELIVERY_CONSTANTS.PICKUP_ADDRESS.coordinates.lng],
                    {

...
export function AddressAutocomplete({
    ...
    useEffect(() => {
        console.log('Address autocomplete: using Yandex Geocoder API for suggestions')
    }, [])
    ...
    const getSuggestions = useCallback(async (query: string) => {
        ...
        try {
            ...
            if (apiKey) {
                ...
                console.warn('No Yandex API key provided (NEXT_PUBLIC_YANDEX_API_KEY), using fallback suggestions')
                showFallbackSuggestions(query)
            }
        } catch (error) {
    ...
    const highlightMatches = (text: string, highlights?: Array<[number, number]>) => {

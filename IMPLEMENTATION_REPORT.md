...
**Файлы:**
- ✅ `lib/cities.ts` - База данных с 21 городом и правильными склонениями
...
- [x] Все 21 город добавлены в `lib/cities.ts`
